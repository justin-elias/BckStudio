                ...
                <GridItem xs={12} sm={12} md={6} key={nanoid()}>
                  <Card
                    ...
                    <GridItem xs={12} sm={12} md={6}
                      ...
                      <Image src={person.staffPicture.url} width={width} height={height} alt={person.staffPicture.altText} title={person.staffPicture.title} className={imageClasses} placeholder={"blur"} blurDataURL={"/blurDefault.png"}/>
                    </GridItem>
